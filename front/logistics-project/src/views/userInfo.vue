<template>
  <div style="width: 1200px; margin: 0 auto">
    ...
    <el-button type="primary" icon="el-icon-edit"
               style="display: inline-block; float: right; margin-right: 10px; margin-top: 10px" @click="changeEdit"
               circle></el-button>
    <el-popover
        placement="top"
        width="160"
      ...
      <el-button slot="reference" style="float:right; margin-right: 10px; width: 80px; margin-top: 10px"
                 v-show="showEditBtn" type="success" icon="el-icon-check" round></el-button>
    </el-popover>
    <el-descriptions class="margin-top" :column="2" :size="size" border>
      <el-descriptions-item span="2">
        ...
        <el-upload
          ...
          <div slot="tip" class="el-upload__tip" style="display: inline-block; margin-left: 10px">只能上传jpg文件，且不超过10MB
          </div>
        </el-upload>
